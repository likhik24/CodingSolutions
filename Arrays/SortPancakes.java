...
//READ THE INPUT CAREFULLY SO ALL ELEMENTS IN ARR ARE IN RANGE OF 0 TO ARR.LENGTH

import java.util.*;

public class SortPancakes {

    //we can use bubblesort technique to pick highest value in array and put it in place
