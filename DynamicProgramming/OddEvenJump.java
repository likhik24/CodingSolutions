...
public class OddEvenJump {
        ...
        // for every index need to find index of smallest greatee value than that index which is closer
        //  largest smaller value than that index which is closer


        public int oddEvenJumps(int[] arr) {
            boolean[][] dp = new boolean[arr.length][2];

            // dp[0] //index of smaller greater value than that index
            //     dp[i][1] // largest smaller value than that index closer to it
